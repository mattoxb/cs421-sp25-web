...
**This project information is legacy stuff.  We will use a different project format this semester.**
...
- Pick a published research paper on a programming language topic [(some may be found here)](https://wiki.haskell.org/Research_papers) and write a two to four page summary, and/or prepare a twenty minute presentation.
